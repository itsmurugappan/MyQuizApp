...
public class AWSResources {
    ...
    public static final String S3_BUCKET_NAME = "muruquiz";
    public static final String SQS_QUEUE_NAME = "QuizApp";
    public static final String DYNAMODB_TABLE_NAME = "quiz_answers";

    public static final String Q_PATH = "questions/";
    public static final String A_PATH = "answers/";
